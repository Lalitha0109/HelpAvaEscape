...
function preload(){
   ...
   helicopter_img=loadAnimation("aeroplane.png","aeroplane.png","aeroplane.png","aeroplane.png","aeroplane.png","blast.png");
...
function draw() {
  ...
  scientist.velocityY = scientist.velocityY + 0.8;
   ...
   if(gameState===1){
      ...
      strokeWeight(4);
      textSize(25);
      text("press space key to jump in level1 \n press space key + right arrow key to jump and move forward in level2",20,displayHeight/2+300);
   ...
   if(scientist.x>=num){
      ...
      text("Congratuations!! Level completed.Ava has  found enough fuel for her to escape from here.",scientist.x-500,scientist.y-250);
      image(fuel_img,scientist.x+100,100,150,150);
